...
# Configuration
# NOTE: Update this URL if "leads 4" has a different table ID in NocoDB
...
DATA_FILE = "/Users/sergirodriguezzambrana/n8n/leads_4_data.tsv"
...
if __name__ == "__main__":
    delete_all_records() # Clear the table first for a clean test
    if os.path.exists(DATA_FILE):
        leads = parse_data(DATA_FILE)
        if leads:
            print(f"Found {len(leads)} unique records after parsing. Attempting import...")
